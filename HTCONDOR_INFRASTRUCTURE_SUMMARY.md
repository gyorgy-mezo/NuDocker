...
|----------|-----------|----------|--------------|
| vCPU | €1.25/vCPU/month | 48 | €60 |
| RAM | €1.00/GB/month | 176 GB | €176 |
| Storage | €0.04/GB/month | 1100 GB | €44 |
| Network | €5/month | 1 floating IP | €5 |
| **Total** | | | **€285/month** |
...
- Runtime: ~18 days
- Cost: €285 × 0.6 = €171
- **Per model**: €171 ÷ 54 = **€3.17**

**Single model**:
- Low-mass (6 hours): €0.30
- Medium-mass (18 hours): €0.95
- High-mass (48 hours): €2.53
...
| Aspect | HTCondor | SLURM |
|--------|----------|-------|
| **Scheduler** | HTCondor | SLURM |
| **Best For** | Parameter sweeps, embarrassingly parallel | HPC, MPI jobs |
| **Job Universe** | Vanilla, Docker, Parallel | Batch, Interactive |
| **Container Support** | Native Docker Universe | Singularity via sbatch |
| **Queue System** | ClassAds, matching | Partitions, QOS |
| **Workflow** | DAGMan (native) | Slurm job arrays |
| **Setup Complexity** | Moderate | Moderate |
| **MESA Suitability** | Excellent (9/10) | Excellent (9/10) |
| **NuDocker Integration** | Custom scripts | Native scripts available |
...
2. **Spot Instances**: Cost optimization with preemptible VMs
