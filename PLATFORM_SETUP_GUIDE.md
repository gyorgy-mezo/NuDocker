...
| **Cost** | Free (own hardware) | Free (own hardware) | Free (own hardware) | Pay-per-use |
| **Scalability** | Limited by hardware | Limited by hardware | Limited by hardware | Scale up/down |
| **Accessibility** | Local only | Local only | Local only | Anywhere |
| **Data Persistence** | Permanent | Permanent | Permanent | Need volumes |
| **Best For** | Personal workstation | Mac users (Intel) | Learning only | Large runs, collaboration |
| **Compile Time** (r9575) | 10-15 min | 10-15 min | 30-40 min | 8-12 min (8 cores) |
| **Run Time** (7M test) | 5-10 min | 5-10 min | 60-120 min | 3-5 min (8 cores) |
...
- **Considerations**: Cost (monitor usage), need account
